...
import com.speedchat.socket.services.AuthenticationService;
...
public class JwtTokenInterceptor implements HandshakeInterceptor {
    ...
    public boolean beforeHandshake(ServerHttpRequest request, ServerHttpResponse response, WebSocketHandler wsHandler,
        ...
        try {
            ...
            logger.info("The user is {}The Room ID received is {} with userName: {}", isAuthenticated ? " with Authenticated! " : "not Authenticated! ", roomId, userData.getString("userName"));
